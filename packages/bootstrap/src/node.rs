...
impl Node {
    ...
    pub fn meta(&self) -> Result<fs::Metadata> {
        self.path
            .symlink_metadata()
    ...
    pub fn is_dir(&self) -> bool {
        (self.inode.i_mode & libc::S_IFDIR as u32) == libc::S_IFDIR as u32
    }

    pub fn is_symlink(&self) -> bool {
        self.inode.i_mode & libc::S_IFLNK as u32 == libc::S_IFLNK as u32
    }

    pub fn is_reg(&self) -> bool {
        self.inode.i_mode & libc::S_IFREG as u32 == libc::S_IFREG as u32
    }

    pub fn is_special(&self) -> bool {
        self.inode.i_mode & (libc::S_IFBLK | libc::S_IFCHR | libc::S_IFIFO) as u32 != 0
    }
    ...
    pub fn is_overlayfs_whiteout(&self, spec: &WhiteoutSpec) -> bool {
        ...
        #[cfg(target_os = "linux")]
        return (self.inode.i_mode & libc::S_IFMT == libc::S_IFCHR)
