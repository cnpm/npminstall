...
const REGISTRY_TYPES = [
  ...
  // 'version', // egg@1.0.0
  // 'range', // egg@^1
  'git', // egg@https://github.com/eggjs/egg.git
  'file', // egg@/your/local/path/egg-2.29.4.tgz
  'directory', // egg@/your/local/path/egg
  'remote', // egg@https://registry.npm.alibaba-inc.com/egg/download/egg-2.29.4.tgz
];
