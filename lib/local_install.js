...
const debug = require('util').debuglog('npminstall:local_install');
...
async function linkPeerDependencies(params) {
  // const pkg = params.package;
  // const packageDir = params.packageDir;
  const ancestors = params.needLinkPeerDependenciesAncestors;
...
async function linkPeer(options) {
  ...
  if (options.linkPeerDependencies.length > 0) {
