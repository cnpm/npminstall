...
module.exports = function dependencies(pkg, options) {
  ...
  return {
    ...
    get all() {
      return mergeOptional(all, optionalDependencies, options.nested);
    },
    ...
    get prod() {
      return mergeOptional(prod, optionalDependencies, options.nested);
    },
    ...
    get client() {
      return mergeOptional(client, optionalDependencies, options.nested);
    },
  };
};
