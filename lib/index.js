...
module.exports = function*(options) {
  ...
  options.console.info(chalk.green('All packages installed (%s packages, use %s, speed %s/s, json %s(%s), tarball %s)'),
    options.downloadPackages, ms(totalUse), bytes(avgSpeed),
